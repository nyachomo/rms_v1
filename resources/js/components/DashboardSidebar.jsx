...
const GROUPS = [
    ...
    },
    {
        ...
        items: [
            ...
            { label: 'My Fees',             to: '/dashboard/learning/my-fees',              icon: 'fas fa-money-bill-wave', perm: ['fee_management',    'view'] },
            { label: 'Registration Fee',  to: '/dashboard/learning/registration-fee',     icon: 'fas fa-id-card',         perm: ['registration_fees', 'view'] },
            { label: 'My Assessments',    to: '/dashboard/learning/assessments',          icon: 'fas fa-clipboard-list',  perm: ['learning',          'view'] },
    ...
    },
    {
        ...
        items: [
            ...
            { label: 'Registration Fees', to: '/dashboard/registration-fees', icon: 'fas fa-id-card',         perm: ['registration_fees',   'create'] },
            { label: 'Class Assessments', to: '/dashboard/class-assessments', icon: 'fas fa-clipboard-list',     perm: ['class_assessments',   'view'] },
